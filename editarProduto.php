        ...
        <div class="container tamanhoFormulario">
            <form action="atualizarProduto.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="quantProduto" value = "<?php echo $quantProduto ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="forProduto">
